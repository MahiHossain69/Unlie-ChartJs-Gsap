...
export default function AccountCard({ account }: AccountCardProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center xl:justify-between  gap-4 sm:gap-0 py-4 px-4 sm:px-3  bg-white dark:bg-white/10 rounded-lg transition-colors">
      ...
      <div className="flex flex-wrap gap-x-6 gap-y-3 sm:gap-1 flex-1">
        <div className="bg-[#FF83831A]/10 px-1 rounded-md">
          <Metric
            icon={<TbAlertHexagonFilled className="w-4 h-4 text-red-500" />}
      ...
      <div className="self-start sm:self-auto">
        <Button
          ...
          className="bg-[#473BF0] hover:bg-blue-700  text-white px-4 py-2 rounded-md text-[14px] font-medium flex items-center gap-2"
        >
