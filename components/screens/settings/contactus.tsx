...
export default function ContactModal({ isOpen, onClose }: ContactModalProps) {
  ...
  return (
    <div id='contactus' className="fixed inset-0 z-50 flex items-center justify-center">
      {/* Overlay */}
      <div 
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Name"
              className="w-full px-3 py-2 dark:text-white  bg-gray-100 placeholder:text-[#0000]/50 dark:placeholder:text-[white]/50 dark:!border-white/10 !border font-space placeholder:text-[13px] placeholder:font-normal placeholder:font-space !border-[#D0D5DD] dark:bg-[rgba(255,255,255,0.1)] text-black border-[rgba(255,255,255,0.1)] rounded-lg"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={handleInputChange}
              placeholder="Email"
              className="w-full px-3 py-2 dark:text-white bg-gray-100 placeholder:text-[#000]/50 dark:placeholder:text-[white]/50 dark:!border-white/10 !border font-space placeholder:text-[13px] placeholder:font-normal placeholder:font-space !border-[#D0D5DD] dark:bg-[rgba(255,255,255,0.1)] text-black border-[rgba(255,255,255,0.1)] rounded-lg"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              rows={4}
              className="w-full px-3 py-2 dark:text-white  bg-gray-100 placeholder:text-[#0000]/50 dark:placeholder:text-[white]/50 dark:!border-white/10 !border font-space placeholder:text-[13px] placeholder:font-normal placeholder:font-space !border-[#D0D5DD] dark:bg-[rgba(255,255,255,0.1)] text-black border-[rgba(255,255,255,0.1)] rounded-lg resize-none"
            />
          </div>
