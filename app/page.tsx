...
export default function Dashboard() {
  ...
  const [isChecked, setIsChecked] = useState(false); // ✅ Added this line
  const toggleCheckbox = () => setIsChecked((prev) => !prev); // ✅ Added this line
  ...
  if (!authenticated) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[rgb(7,12,32)] px-4">
        <div className="max-w-md bg-[#FFFFFF0A] border border-white/10 w-full space-y-6 rounded-2xl shadow-lg p-8">
          {!showForgot ? (
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="flex items-center justify-between mt-2">
                <label className="flex items-center font-space text-[16px] font-normal text-[#fff] gap-2 text-sm cursor-pointer">
                  <div
                  ...
                  >
                    ...
                    <div
                      className={`
          w-[20px] h-[20px] rounded flex items-center justify-center bg-[#FFFFFF0A]
          ${isChecked ? "border-transparent" : "border border-[#98A2B3]"}
          transition-all duration-300 ease-in-out group-hover:border-[#473BF0]
        `}
                    >
                      <FaSquareCheck
                        className={`
          ...
          `}
            ...
            <div className="space-y-6 text-center">
              <Image
                src={Email}
                alt="Email Sent"
                className="mx-auto w-[120px] h-[106px]"
              />
              <h1 className="text-center font-space font-bold text-[24px] text-white">
                Check Your Email
              </h1>
